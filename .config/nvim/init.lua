...
require('lazy').setup({
  ...
  -- Highlight todo, notes, etc in comments
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '[tl', ':TodoQuickFix<CR>', { desc = 'Open [T]odo [L]ist' })
      vim.keymap.set('n', '[tt', ':TodoTelescope<CR>', { desc = 'Open [T]odo [T]elescope' })
    end,
  },
  -- TODO
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      local languages = { 'bash', 'cpp', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'vim', 'vimdoc' }
      ...
      vim.api.nvim_create_autocmd('FileType', {
        ...
        callback = function()
          ...
          -- Keep C++ indentation disabled, matching the previous nvim-treesitter config.
          if vim.tbl_contains({ 'cpp', 'ruby' }, vim.bo.filetype) then
            return
          end
